 ...
 *
 * mod-97 alone accepts about one in ninety-seven random strings of the right
 * shape, which is how `BB7120133083564` — an Indian driving licence number —
 * validated as a Barbados IBAN. Barbados IBANs are 28 characters. Every
 * country's length is fixed and published, so checking it turns a one-in-97
 * guess into a real proof.
 */
export const IBAN_LENGTH = {
  ...
  // Barbados is deliberately present with its real length; see the note above.
  BB: 28,
};
